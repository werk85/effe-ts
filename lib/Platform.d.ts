...
export declare function programWithFlags<Flags, Model, Action>(init: (flags: Flags) => State<Model, Action>, update: (action: Action, model: Model) => State<Model, Action>, subscriptions?: (model: Model) => Sub<Action>): (flags: Flags) => Program<Model, Action>;
